...
import { selectAttachData } from '../../redux/Attach/selectors.js';

export const ImgModal = ({ onClose }) => {
  const attachData = useSelector(selectAttachData);

  const base64ImageSrc = attachData
    ? `data:image/png;base64,${attachData}`
    : null;
    ...
    <Overlay>
      <Modal>
        <Info>
          ...
          {base64ImageSrc && (
            <img src={base64ImageSrc} alt="Uploaded content" />
          )}
        </Info>
      </Modal>
    </Overlay>
