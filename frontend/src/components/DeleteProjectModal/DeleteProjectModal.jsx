...
import {
  ...
  Modal,
  Overlay,
} from './DeleteProjectModal.styled.js';
export const DeleteProjectModal = ({ onClose, deleteProject }) => {
  useEffect(() => {
    ...
    <Overlay>
      <Modal>
        <Info>
          ...
          >
            Ви впевненні що хочете видалити проєкт?
          </h2>
          <div style={{ display: 'flex', flexDirection: 'row', gap: '35px' }}>
            <button onClick={deleteProject} style={{ fontSize: '24px' }}>
              Так
            </button>
